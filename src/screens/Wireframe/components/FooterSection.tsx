...
export const FooterSection = ({ footerLinks, socialLinks }: FooterSectionProps): JSX.Element => (
  <footer className="absolute w-full h-[330px] top-[3100px] left-0 bg-[#170b28] border border-solid border-[#ffffff33] flex items-center justify-between px-12 pb-16">
